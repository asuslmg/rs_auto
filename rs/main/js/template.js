...
//Primary use:	Famosa Admin - Responsive Admin Template
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.layout'
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.pushmenu'
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.controlsidebar'
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.boxwidget'
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.todolist'
...
+function ($) {
  ...
  var DataKey = 'famosaadmin.directchat'
